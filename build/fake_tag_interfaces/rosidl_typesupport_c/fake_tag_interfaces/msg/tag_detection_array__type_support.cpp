...
static const _TagDetectionArray_type_support_symbol_names_t _TagDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fake_tag_interfaces, msg, TagDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fake_tag_interfaces, msg, TagDetectionArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fake_tag_interfaces, msg, TagDetectionArray)() {
  return &::fake_tag_interfaces::msg::rosidl_typesupport_c::TagDetectionArray_message_type_support_handle;
}
